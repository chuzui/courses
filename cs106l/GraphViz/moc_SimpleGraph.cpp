...
static const char qt_meta_stringdata_SimpleGraph[] = {
    "SimpleGraph\0\0graph\0graphUpdated(SimpleGraph)\0"
};
...
const QMetaObjectExtraData SimpleGraph::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SimpleGraph::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SimpleGraph,
      qt_meta_data_SimpleGraph, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SimpleGraph::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SimpleGraph))
